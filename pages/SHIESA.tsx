  ...
  return (
    <div className="space-y-8 animate-reveal pb-20">
      <div className="flex flex-col md:flex-row justify-between items-start gap-6">
        <div>
          <h2 className="text-4xl font-black uppercase tracking-tighter text-blue-800">SHIESA</h2>
          <p className="text-slate-500 font-medium">SOCIEDADE DE HOMENS DA IESA.</p>
        </div>
      ...
      {activeTab === 'directory' && (
        <MemberManager department="SHIESA" title="Diretório SHIESA" />
      )}
